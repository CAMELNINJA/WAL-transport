...
import (
	...
	"github.com/CAMELNINGA/cdc-postgres/internal/repository"
	"github.com/CAMELNINGA/cdc-postgres/internal/usecase"
...
func main() {
	...
	conn, rConn, err := postgres.InitPgxConnections(config.Database)
	if err != nil {
		logger.Error(err)
		return
	}
